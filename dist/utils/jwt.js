...
const signJwt = (payload, keyName, options) => {
    const privateKey = Buffer.from((0, helpers_1.getEnvVariable)(keyName), "base64").toString("ascii");
...
const verifyJwt = (token, keyName) => {
    try {
        const publicKey = Buffer.from((0, helpers_1.getEnvVariable)(keyName), "base64").toString("ascii");
